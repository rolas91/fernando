...
const CATALOG_SEED = [
  ['item_cone_28', 'CONE-28', '28" Traffic Cone', 'Cone', '1.50', 'Each', 'active'],
  ['item_cone_36', 'CONE-36', '36" Traffic Cone', 'Cone', '2.00', 'Each', 'active'],
  ['item_base_18', 'BASE-18', '18" Rubber Base', 'Base', '0.80', 'Each', 'active'],
  ['item_base_24', 'BASE-24', '24" Rubber Base', 'Base', '1.20', 'Each', 'active'],
  ['item_sign_rw', 'SIGN-RW', 'Road Work Sign', 'Sign', '2.00', 'Each', 'active'],
  ['item_sign_det', 'SIGN-DET', 'Detour Sign', 'Sign', '2.00', 'Each', 'active'],
  ['item_barr_8', 'BARR-8', "8' Type III Barricade", 'Barricade', '1.75', 'Each', 'active'],
  ['item_light_tma', 'LIGHT-TMA', 'TMA Arrow Board Light', 'Equipment', '15.00', 'Each', 'active'],
  ['item_drum_18', 'DRUM-18', '18" Traffic Drum', 'Drum', '1.25', 'Each', 'active'],
];
      ...
      await queryRunner.query(
        `
          INSERT INTO commercial_catalog_items
            (id, sku, description, type, daily_rate, unit, status, created_at, updated_at)
